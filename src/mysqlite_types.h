...
enum errstat {
  MYSQLITE_OK = 0,
  MYSQLITE_CORRUPT_DB,
  MYSQLITE_PERMISSION_DENIED,
  MYSQLITE_NO_SUCH_TABLE,
  MYSQLITE_IO_ERR,
  MYSQLITE_DB_FILE_NOT_FOUND,
  MYSQLITE_OUT_OF_MEMORY,
  MYSQLITE_CONNECTION_ALREADY_OPEN,
  MYSQLITE_FLOCK_NEEDED,
  MYSQLITE_CANNOT_OPEN_DB_FILE,
};
